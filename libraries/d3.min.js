...
(function (t, n) {
				...
				: function (t) {
						return function () {
							var n = this.ownerDocument,
								e = this.namespaceURI;
							return e === Ks &&
								n.documentElement.namespaceURI === Ks
								? n.createElement(t)
		...
		return function (u) {
			...
			var f,
				...
				T = {
					...
					lineEnd: function () {
						f &&
							(s(p, d), v && m && M.rejoin(), f.push(M.result())),
							(T.point = c),
							m && w.lineEnd();
					},
					polygonStart: function () {
						...
						case "r":
							null != r.precision ||
								isNaN(
									(i = He(
										a,
										Math.max(Math.abs(o), Math.abs(u))
									))
								) ||
			...
			(function (t, n, e, r) {
				...
				(function (t, n, e, r) {
					...
					for (i = 0; i < g; ++i)
						if ((o = L_[i])) {
							for (
								u = o.site, a = (c = o.halfedges).length;
								a--;
	...
	Zo.prototype = Ko.prototype = {
		...
		defer: function (t) {
			...
			return (
				n.push(t), ++this._waiting, this._tasks.push(n), Go(this), this
			);
		},
		abort: function () {
	...
	(Es.prototype = Ss.prototype),
		...
		(t.histogram = function () {
			...
			return (
				...
				(t.domain = function (n) {
					return arguments.length
						? ((e = "function" == typeof n ? n : c([n[0], n[1]])),
						  t)
						: e;
				}),
